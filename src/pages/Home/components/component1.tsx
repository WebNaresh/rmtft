    ...
    <section className="text-gray-700 body-font">
      <div className="container px-5 py-24 mx-auto">
        <SmallCard
          title={"RMTFT"}
          description={
            "RMTFT is a React component library designed to provide beautiful UI elements for your web applications. It offers ready-to-use components styled with Tailwind CSS, making customization and integration effortless."
          }
          direction={true}
        />
        <SmallCard
